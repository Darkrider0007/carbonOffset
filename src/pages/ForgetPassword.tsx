...
import { resetPassword, sendMailForForgetPassword } from '../api/auth/forgetPassword';
...
function ForgetPassword() {
    ...
    const onChangePasswordSubmit: SubmitHandler<FormDataForPasswordChange> = async (data: any) => {
        try {
            const res = await resetPassword({ id: userId, otp: data.otp, password: data.password });

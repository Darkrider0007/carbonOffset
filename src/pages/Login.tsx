        ...
        <div className='min-h-screen w-full bg-[#F1F5F9] flex justify-between items-center'>
            <div className='flex flex-col md:flex-row w-full'>
                ...
                <div className='hidden md:flex w-full md:w-1/2 bg-cover bg-center items-center'>
                    <img src={windowImage} alt="Nature" className='object-cover h-[300px] md:h-[640px] w-full md:w-[680px]' />
                </div>

                {/* Right side form */}
                <div className='w-full md:w-1/2 p-8 md:px-32 justify-center'>
                    <div onClick={() => navigate("/")} className="absolute top-1 right-1 mb-6 md:mb-0">
                        <img src={Logo} alt="Logo" className='md:right-9 h-20 md:h-36 w-20 md:w-36 object-cover' />
                    </div>

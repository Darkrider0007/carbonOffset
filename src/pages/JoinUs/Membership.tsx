    ...
    <div>
      ...
      <div className="px-5 md:px-20 py-10 text-gray-800">
        ...
        <p className="text-lg mb-6">
          Joining SFUO opens a world of personal and professional opportunities.
          Whether as an individual or corporate member, you connect with a
          network of like-minded people to create peace-focused projects and
          shape a future where sustainable living is a reality.
        </p>
        ...
        <div className="mb-10">
          ...
          <p className="text-lg mb-4">
            ...
            global networking for professional, social, and personal interests.
            SFUO invites individuals to contribute to global initiatives,
            whether through volunteering, forming a virtual government, or
            launching local-to-global projects.
          </p>
        ...
        <div className="mb-10">
          ...
          <p className="text-lg mb-4">
            ...
            villages while leveraging a vast network of expertise and resources.
          </p>
          <ul className="list-disc ml-8 mb-6">
            <li>
            ...
            <li>
              Business affiliate status with futurecity Inc. for mega-projects.
            </li>
            <li>
        ...
        <div className="mb-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg mb-4">
              ...
              <strong>$100 per month</strong>, members invest in a future living
              space, contributing to eco-friendly infrastructure.
            </p>
            <p className="text-lg mb-4">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg mb-4">
              Members can secure a place for their children at an international
              institute through monthly contributions of <strong>$100</strong>.
              Contributions accumulate over five years, allowing members to
              either withdraw or continue investing based on circumstances.
            </p>
            <p className="text-lg">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg mb-4">
            Membership fees are non-refundable, but installment payments towards
            futurecity options are refundable after each five-year block. For
            example, after five years of monthly payments totaling
          ...
          <p className="text-lg mb-4">
            ...
            eco-friendly settings, with options that include lifetime retirement
            housing or professional education for family members.
          </p>
        </div>

        {/* Contact Information */}
        <div className="mb-10">
          <h3 className="text-3xl font-bold text-green-600 mb-4">Contact Us</h3>
          <p className="text-lg mb-4">

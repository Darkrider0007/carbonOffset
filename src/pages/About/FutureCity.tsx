      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <section className="text-center mb-12 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            interdisciplinary and multi-functional areas that cut across various
            domains of information technology, medical science, engineering, and
            social dynamics. We are a team of researchers, inventors, and domain
            experts engaged in developing and implementing high-tech projects.
          </p>
        </section>
        ...
        <section className="flex flex-col md:flex-row gap-8 mb-12">
          <div className="flex-1 bg-green-100 p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              environment of our planet, and help advance human society towards
              a better future.
            </p>
          </div>
          <div className="flex-1 bg-green-100 p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              quality of life, protect the environment, save lives, and promote
              peace towards global integration. We aim to deliver projects,
              products, and services to our clients with professionalism and
              ethical standards.
            </p>
          </div>
        </section>
        ...
        <section className="bg-green-100 p-6 rounded-lg shadow-lg text-center mb-12">
          ...
          <p className="text-gray-700 leading-relaxed max-w-2xl mx-auto">
            ...
            solutions, invent to add value, integrate the new with the old, and

      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <section className="mb-12 p-6 bg-green-100 rounded-lg shadow-lg">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            global integration and universal interdependence among communities.
          </p>
        </section>
        ...
        <section className="mb-12 p-6 bg-green-100 rounded-lg shadow-lg">
          ...
          <p className="text-gray-700 leading-relaxed">
            Bring together researchers, scientists, technocrats, and volunteers
            in a network to innovate, create, launch, and implement projects
            supporting SFUO vision in the most professional, competent, and
